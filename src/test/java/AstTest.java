...
public class AstTest extends AbstractTestSupport {
    ...
    @Test
    public void testBlockThrowsTag() throws IOException {
        verifyAst(getPath("blockThrows.txt"), getPath("blockThrows.javadoc"));
    }
    ...
    @Test
    public void testBlockVersionTag() throws IOException {
        verifyAst(getPath("blockVersion.txt"), getPath("blockVersion.javadoc"));
    }

    @Test
    public void testBlockHiddenTag() throws IOException {
        verifyAst(getPath("blockHidden.txt"), getPath("blockHidden.javadoc"));
    }

    @Test
    public void testBlockUsesAndProvidesTags() throws IOException {
        verifyAst(getPath("blockUsesAndProvides.txt"), getPath("blockUsesAndProvides.javadoc"));
    }

    @Test
    public void testBlockTagLocation() throws IOException {
        verifyAst(getPath("blockTagLocation.txt"), getPath("blockTagLocation.javadoc"));
    }

    @Test
    public void testSeeTag() throws IOException {
        verifyAst(getPath("seeTag.txt"), getPath("seeTag.javadoc"));
    }

    @Test
    public void testCustomBlockTag() throws IOException {
        verifyAst(getPath("customBlockTag.txt"), getPath("customBlockTag.javadoc"));
    }
    ...
    @Test
    public void testSerialAndSerialDataTags() throws IOException {
        verifyAst(getPath("serialAndSerialData.txt"), getPath("serialAndSerialData.javadoc"));
    }
